package com.woniu.smartremind.uitl;
...
public class ToPinyin {
    ...
    public static void main(String[] args) {
        String s = "颠覆国家政权罪";
        System.out.println(getSimpleCode(s));
        System.out.println(getFullCode(s));
    }

    public static String getSimpleCode(String msg){
        StringBuffer buffer = new StringBuffer();
        char[] chars = msg.toCharArray();
        for (char aChar : chars) {
            String pinyin = change(aChar+"");
            if(pinyin!=null){
                buffer.append(pinyin.substring(0,1));
            }
        }
        return buffer.toString();
    }

    public static String getFullCode(String msg){
        return change(msg);
    }
