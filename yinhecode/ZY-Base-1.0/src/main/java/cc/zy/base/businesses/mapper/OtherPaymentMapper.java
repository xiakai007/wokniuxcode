 ...
 */
public interface OtherPaymentMapper extends BaseMapper<OtherPayment> {

      <T> IPage<OtherPayment> findOtherPaymentDetailPage(Page<T> page, @Param("otherPayment") OtherPayment otherPayment);


        long countOtherPaymentDetail(@Param("otherPayment") OtherPayment otherPayment);
     ...
     */
    List<OtherPayment> findOtherPaymentDetail(@Param("OtherPayment") OtherPayment otherPayment);


        /**
     * 通过ID查找用户
     *
     * @param otherPaymentId otherPaymentId
     * @return 院校
     */
    OtherPayment findById(Integer otherPaymentId);
