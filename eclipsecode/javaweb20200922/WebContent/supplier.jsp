   ...
   <table class="table table-striped table-bordered table-hover" style="width:70%;margin:20px auto;">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
              <a href="supplierList.do?supp_id=<%=supplier.getSupp_id()%>&oper=del" class="btn btn-danger btn-xs">
                                                   删除
              </a>
              <a href="supplierList.do?supp_id=<%=supplier.getSupp_id()%>&oper=upd" class="btn btn-warning btn-sm">
                                                   修改
              </a>                                     
            </td>
         </tr>
