...
function sendData(){
	  ...
	  //设置xmlHttp对象
	  xmlHttp.open("post","user.do?oper=check",true);
	  //设置请求头
...
<body>
  <div class="container-fluid">
		    ...
		    <div class="row" style="height:400px;">
		       <div class="col-lg-12">
		       <!-- BS中的水平表单 -->
					<form class="form-horizontal" action="user.do?oper=add" method="post" id="form1" onsubmit="return checkData()" name="myform">
