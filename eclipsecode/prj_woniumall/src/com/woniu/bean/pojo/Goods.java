...
public class Goods {
	...
	public Goods(String name, String goodsno, String author, String publisher, String pubtime, Category category,
	...
	public String toString() {
		return "Goods [id=" + id + ", name=" + name + ", goodsno=" + goodsno + ", author=" + author + ", publisher="
				+ publisher + ", pubtime=" + pubtime + ", category=" + category + ", description=" + description
