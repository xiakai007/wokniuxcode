...
public class Goods {
	...
	public Goods(String name, String goodsno, String author, String publisher, Integer categoryid, String newest,
			String hot) {
		super();
		this.name = name;
	...
	public Goods(Integer id, String name, String author, String publisher) {
		super();
		this.id = id;
		this.name = name;
		this.author = author;
	...
	public Goods(String name, String author, String publisher) {
		super();
		this.name = name;
		this.author = author;
		this.publisher = publisher;
	...
	public Goods(Integer id, String name, String goodsno, String author, String publisher, Integer categoryid,
			String newest, String hot) {
		super();
		this.id = id;
		this.name = name;
		this.goodsno = goodsno;
	...
	public String toString() {
		return "Goods [id=" + id + ", name=" + name + ", goodsno=" + goodsno + ", author=" + author + ", publisher="
				...
				+ salenums + ", newest=" + newest + ", hot=" + hot + ", status=" + status + ", categoryname="
				+ categoryname + "]";
	}
