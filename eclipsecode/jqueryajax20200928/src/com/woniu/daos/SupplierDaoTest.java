...
import com.woniu.entities.MySupplier;
import com.woniu.entities.PageBean;
import com.woniu.entities.Supplier;
import com.woniu.tools.ConnMana;
import com.woniu.tools.JDBCTools;

public class SupplierDaoTest {
	public List<Supplier> getAllSuppliers() throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException, SecurityException{
		...
		try{
		    ...
		    rs=pst.executeQuery();
		    listSuppliers=JDBCTools.getList(rs, Supplier.class);
	...
	public List<MySupplier> getMyAllSuppliers() throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException, SecurityException{
		List<MySupplier> listSuppliers=new ArrayList<>();
		Connection conn=JDBCTools.getConnection();
		PreparedStatement pst=null;
		ResultSet rs=null;
		String sql="select * from supplier";
		try{
			pst=conn.prepareStatement(sql);
		    rs=pst.executeQuery();
		    listSuppliers=JDBCTools.getMyList(rs, MySupplier.class);
		    System.out.println(listSuppliers);
		    return listSuppliers;
		}finally{
			ConnMana.closeSRC(pst, rs, conn);
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, NoSuchFieldException, SecurityException, SQLException {
		new SupplierDaoTest().getAllSuppliers();
		System.out.println("---------------------------");
		new SupplierDaoTest().getMyAllSuppliers();
	}
