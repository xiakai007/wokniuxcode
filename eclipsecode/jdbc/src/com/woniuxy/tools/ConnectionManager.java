...
public class ConnectionManager {
	...
	private final static String CONNECTION_URL = "jdbc:mysql://localhost:3306/goods_dqlquery?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai";
    private final static String USER_NAME = "root";
    private final static String USER_PWD = "123456";
    
    public static Connection getCounnection() {
    	try {
