...
public class SwaggerJavaConfig {
    ...
    public Docket getDocket(){
        ...
        Docket newDocket = apisb.apis(RequestHandlerSelectors.basePackage("com.woniu.mymall.controller")).build();
        return newDocket;
    }
    public ApiInfo getApiInfo(){
        ApiInfo apiInfo=new ApiInfoBuilder().title("mymall平台")
                .description("mymallAPI接口")
